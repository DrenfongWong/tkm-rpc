...
package TKMRPC.Request.IKE.cc_set_user_certificate
is

   Data_Size : constant := 1052;
   ...
   for Data_Type use record
      ...
      ri_id at 8 range 0 .. (8 * 8) - 1;
      autha_id at 16 range 0 .. (8 * 8) - 1;
      certificate at 24 range 0 .. (1028 * 8) - 1;
   end record;
