...
package Tkmrpc.Response.Ike.Cc_Add_Certificate is
   ...
   Null_Response : constant Response_Type :=
      Response_Type'
     (Header  =>
     Response.Header_Type'(Operation  => Operations.Ike.Cc_Add_Certificate,
                           Result     => Results.Invalid_Operation,
                           Request_Id => 0),
      Padding => Padding_Type'(others => 0));

end Tkmrpc.Response.Ike.Cc_Add_Certificate;
