...
package Tkmrpc.Request.Ike.Isa_Skip_Create_First is
   ...
   Null_Request : constant Request_Type :=
      Request_Type'
     (Header  =>
     Request.Header_Type'(Operation  => Operations.Ike.Isa_Skip_Create_First,
                          Request_Id => 0),
      Data    => Data_Type'(Isa_Id => Types.Isa_Id_Type'First),
      Padding => Padding_Type'(others => 0));

end Tkmrpc.Request.Ike.Isa_Skip_Create_First;
